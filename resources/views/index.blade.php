    ...
    <div class="popular-movies">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
            <div class="mt-8">
                ...
                <div class="mt-2">
                    <a href="#" class="text-lg mt-2 uppercase font-bold text-white hover:text-gray-500">Parasite</a>
            ...
            <div class="mt-8">
                ...
                <div class="mt-2">
                    <a href="#" class="text-lg mt-2 uppercase font-bold text-white hover:text-gray-500">Joker</a>
                    <div class="flex items-center text-gray-400 text-sm mt-1">
                        <svg class="fill-current text-orange-500 w-4" viewBox="0 0 24 24">
                            <g data-name="Layer 2">
                                <path
            ...
            <div class="mt-8">
                ...
                <div class="mt-2">
                    <a href="#" class="text-lg mt-2 uppercase font-bold text-white hover:text-gray-500">Sonic The
                        Hedgehog</a>
                    <div class="flex items-center text-gray-400 text-sm mt-1">
                        <svg class="fill-current text-orange-500 w-4" viewBox="0 0 24 24">
                            <g data-name="Layer 2">
            ...
            <div class="mt-8">
                ...
                <div class="mt-2">
                    <a href="#" class="text-lg mt-2 uppercase font-bold text-white hover:text-gray-500">Frozen II</a>
                    <div class="flex items-center text-gray-400 text-sm mt-1">
                        <svg class="fill-current text-orange-500 w-4" viewBox="0 0 24 24">
                            <g data-name="Layer 2">
                                <path
