    ...
    <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
        <div class="flex-none">
            ...
            <ul class="flex items-center mt-4">
                ...
                @if($actorSocialMedia['facebook'])
                    <li>
                        <a href="{{ $actorSocialMedia['facebook'] }}" title="Facebook">
                ...
                @if($actorSocialMedia['instagram'])
                    <li class="ml-6">
                        <a href="{{ $actorSocialMedia['instagram'] }}" title="Instagram">
                ...
                @if($actorSocialMedia['twitter'])
                    <li class="ml-6">
                        <a href="{{ $actorSocialMedia['twitter'] }}" title="Twitter">
        ...
        <div class="md:ml-24">
            <h2 class="text-4xl uppercase text-white tracking-wider font-semibold">{{ $actor['name'] }}</h2>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8">
                @foreach($knownFor as $movie)
                    <div class="mt-4">
                        <a href="{{ $movie['link_movie'] }}">
                            <img src="{{ $movie['poster_path'] }}" alt="poster" class="hover:opacity-75 transition ease-in-out duration-150">
                        </a>
                        <a href="{{ $movie['link_movie'] }}" class="text-sm leading-normal block text-gray-400 hover:text-white mt-1">
                        {{ $movie['title'] }}
                        </a>
                    </div>
                @endforeach
...
</div> <!-- End of actor info -->

<div class="actor-credits border-b border-gray-800" x-data="{isOpen: false, image:''}">
    <div class="container mx-auto px-4 py-16">
        <h2 class="text-4xl text-white uppercase tracking-wider font-semibold">Credits</h2>
